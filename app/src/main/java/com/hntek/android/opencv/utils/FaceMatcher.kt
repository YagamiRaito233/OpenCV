...
class FaceMatcher {
     ...
     * @deprecated 使用 verifyFaces 获取更详细的验证结果
     */
    @Deprecated("使用 verifyFaces 获取更详细的验证结果", ReplaceWith("verifyFaces(face1, face2).confidence"))
    fun compareFaces(face1: Mat, face2: Mat): Double {
        return verifyFaces(face1, face2).confidence
    }
